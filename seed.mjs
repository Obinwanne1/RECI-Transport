...
const { error: vErr } = await supabase.from('vehicles').upsert([
  { id: 'v0000000-0000-0000-0000-000000000001', category_id: 'c0000000-0000-0000-0000-000000000001', location_id: 'a1b2c3d4-0000-0000-0000-000000000001', make: 'Volkswagen', model: 'Polo', year: 2023, registration_plate: 'B-RT 1001', fuel_type: 'petrol', transmission: 'manual', color: 'Silver', mileage: 12450, features: ['Bluetooth','USB-C','Rear camera'] },
  { id: 'v0000000-0000-0000-0000-000000000002', category_id: 'c0000000-0000-0000-0000-000000000001', location_id: 'a1b2c3d4-0000-0000-0000-000000000001', make: 'Toyota', model: 'Yaris', year: 2024, registration_plate: 'B-RT 1002', fuel_type: 'hybrid', transmission: 'automatic', color: 'White', mileage: 4800, features: ['Bluetooth','Lane assist','Apple CarPlay','Android Auto'] },
  { id: 'v0000000-0000-0000-0000-000000000003', category_id: 'c0000000-0000-0000-0000-000000000002', location_id: 'a1b2c3d4-0000-0000-0000-000000000001', make: 'Volkswagen', model: 'Golf', year: 2023, registration_plate: 'B-RT 2001', fuel_type: 'petrol', transmission: 'automatic', color: 'Black', mileage: 18200, features: ['Bluetooth','Cruise control','Parking sensors','Apple CarPlay'] },
  { id: 'v0000000-0000-0000-0000-000000000004', category_id: 'c0000000-0000-0000-0000-000000000002', location_id: 'a1b2c3d4-0000-0000-0000-000000000001', make: 'Seat', model: 'Leon', year: 2024, registration_plate: 'B-RT 2002', fuel_type: 'diesel', transmission: 'manual', color: 'Grey', mileage: 9100, features: ['Bluetooth','USB-C','Rear camera','Climate control'] },
  { id: 'v0000000-0000-0000-0000-000000000005', category_id: 'c0000000-0000-0000-0000-000000000003', location_id: 'a1b2c3d4-0000-0000-0000-000000000001', make: 'Volkswagen', model: 'Tiguan', year: 2023, registration_plate: 'B-RT 3001', fuel_type: 'diesel', transmission: 'automatic', color: 'Blue', mileage: 22300, features: ['Bluetooth','Navigation','Panoramic roof','Heated seats','4WD'] },
  { id: 'v0000000-0000-0000-0000-000000000006', category_id: 'c0000000-0000-0000-0000-000000000003', location_id: 'a1b2c3d4-0000-0000-0000-000000000001', make: 'Toyota', model: 'RAV4', year: 2024, registration_plate: 'B-RT 3002', fuel_type: 'hybrid', transmission: 'automatic', color: 'White', mileage: 8700, features: ['Bluetooth','Apple CarPlay','Android Auto','Adaptive cruise','Heated seats'] },
  { id: 'v0000000-0000-0000-0000-000000000007', category_id: 'c0000000-0000-0000-0000-000000000004', location_id: 'a1b2c3d4-0000-0000-0000-000000000001', make: 'Mercedes-Benz', model: 'Sprinter', year: 2022, registration_plate: 'B-RT 4001', fuel_type: 'diesel', transmission: 'manual', color: 'White', mileage: 45600, features: ['Bluetooth','Rear camera','Loading ramp','Bulkhead'] },
  { id: 'v0000000-0000-0000-0000-000000000008', category_id: 'c0000000-0000-0000-0000-000000000004', location_id: 'a1b2c3d4-0000-0000-0000-000000000001', make: 'Ford', model: 'Transit', year: 2023, registration_plate: 'B-RT 4002', fuel_type: 'diesel', transmission: 'automatic', color: 'Silver', mileage: 31200, features: ['Bluetooth','Rear camera','Cruise control','Tow bar'] },
])
