...
const NAV_ITEMS = [
  ...
  { href: '/fleet', label: 'Fleet', icon: 'M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0zM13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0' },
  ...
  { href: '/availability', label: 'Availability', icon: 'M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636' },
]
...
export default function AdminNav({ userEmail }: AdminNavProps) {
  ...
  return (
    <>
      {/* Sidebar */}
      <aside className="w-56 shrink-0 bg-white border-r border-[#E5E7EB] min-h-screen flex flex-col">
        {/* Brand */}
        <div className="h-14 flex items-center px-4 border-b border-[#E5E7EB]">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 bg-[#407E3C] rounded flex items-center justify-center">
              <svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
              </svg>
            </div>
            <span className="text-sm font-bold text-[#1A1A1A]">RECI Admin</span>
          </div>
        </div>
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-2.5 px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                  active
                    ? 'bg-[#F0FDF4] text-[#407E3C] border-l-2 border-l-[#407E3C]'
        ...
        <div className="p-3 border-t border-[#E5E7EB]">
          <p className="text-xs text-[#6B7280] truncate mb-2">{userEmail}</p>
          <button
            onClick={handleSignOut}
            className="w-full text-left text-xs text-[#6B7280] hover:text-[#DC2626] transition-colors"
          >
            Sign out
          </button>
        </div>
